    ...
    public function message()
    {
        ...
        switch (true) {
            case $this->requireUppercase
                ...
                return __('auth.form.password-1', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireNumeric
                ...
                && ! $this->requireSpecialCharacter:
                return __('auth.form.password-2', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireSpecialCharacter
                && ! $this->requireUppercase
                && ! $this->requireNumeric:
                return __('auth.form.password-3', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireNumeric
                && ! $this->requireSpecialCharacter:
                return __('auth.form.password-4', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireSpecialCharacter
                && ! $this->requireNumeric:
                return __('auth.form.password-5', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireNumeric
                && $this->requireSpecialCharacter:
                return __('auth.form.password-6', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireNumeric
                && $this->requireSpecialCharacter
                && ! $this->requireUppercase:
                return __('auth.form.password-7', [
                    'length' => $this->length,
                ]);

            default:
                return __('auth.form.password-8', [
                    'length' => $this->length,
                ]);
        }
    }
