    ...
    <x-jet-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                ...
                @error('description_fr') <span class="error">{{ $message }}</span> @enderror
            </div>
            ...
            <div class="mt-4">
                ...
                @error('nb_bathroom') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
            ...
            <div class="mt-4">
                ...
                @error('square_feet') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                ...
                @error('rent_start_date') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
            ...
            <div class="mt-4">
                ...
                @error('total_tokens') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                ...
                @error('tokens_price') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                ...
                @error('expected_yield') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                ...
                @error('gross_rent_year') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                ...
                @error('gross_rent_month') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                ...
                @error('property_management') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                ...
                @error('jinflow_tax') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                ...
                @error('property_tax') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
            ...
            <div class="mt-4">
                ...
                @error('net_rent_year') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                ...
                @error('net_rent_month') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
