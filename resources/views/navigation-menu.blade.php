                    ...
                    <div class="hidden sm:block">
                        @auth
                            ...
                            <a href="{{ url(\Illuminate\Support\Facades\Auth::user()->is_admin) ? '/admin/dashboard' : '/dashboard' }}" class="text-base font-medium text-white hover:text-indigo-50">
                                <img class="rounded-full" width="30px" height="30px" style="width: 40px;" src="https://media-exp1.licdn.com/dms/image/C4D03AQGfHmKFdlMOxw/profile-displayphoto-shrink_200_200/0/1618677968141?e=1631750400&v=beta&t=vkbV-wxapD49TwT3ZbCGe50OBWiQeLY__H1kAGKPkjA" alt="">
                            </a>
                        @else
